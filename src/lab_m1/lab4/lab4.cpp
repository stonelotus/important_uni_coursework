...
void Lab4::Update(float deltaTimeSeconds)
{
    ...
    {
        modelMatrix = glm::mat4(1);
        modelMatrix *= transform3D::Translate(carTranslateX, 1.5f, carTranslateZ);
        modelMatrix *= transform3D::Scale(3.5f, 1.2f, -2);
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

        modelMatrix = glm::mat4(1);
        modelMatrix *= transform3D::Translate(carTranslateX, 0.3f, carTranslateZ);;
        modelMatrix *= transform3D::Translate(-1.2f, 0.5f, -1.2f);
        modelMatrix *= transform3D::RotateOZ(carAngularStepOZ);
        modelMatrix *= transform3D::Scale(0.8, 0.8, 0.3);
        RenderMesh(meshes["box"], shaders["Simple"], modelMatrix);
