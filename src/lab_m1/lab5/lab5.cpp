...
void Lab5::Update(float deltaTimeSeconds)
{
...

    {
        ...
        modelMatrix = glm::rotate(modelMatrix, RADIANS(23.0f), glm::vec3(0, 1, 1));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-3, 1, 7));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(12.0f), glm::vec3(1, 1, 1));
