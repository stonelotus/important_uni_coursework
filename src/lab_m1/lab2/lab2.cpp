...
void Lab2::Init()
{
    ...
    // by definition!
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(252, 186, 3), glm::vec3(0.2, 0.8, 0.6)),  //0 
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(252, 186, 3), glm::vec3(0.2, 0.8, 0.6)),//1
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 255, 242), glm::vec3(0.2, 0.8, 0.6)),    //2
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(252, 186, 3), glm::vec3(0.2, 0.8, 0.6)),    //3

            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(252, 0, 3), glm::vec3(0.2, 0.8, 0.6)),  //4
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 255, 242), glm::vec3(0.2, 0.8, 0.6)),//5
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0, 3), glm::vec3(0.2, 0.8, 0.6)),    //6
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 3), glm::vec3(0.2, 0.8, 0.6)),    //7

            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(255, 0, 0), glm::vec3(0.2, 0.8, 0.6)),  //8
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(255, 0, 0), glm::vec3(0.2, 0.8, 0.6)),//9
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(255, 0, 0), glm::vec3(0.2, 0.8, 0.6)),    //10
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 255, 242), glm::vec3(0.2, 0.8, 0.6)),    //11
        ...
        CreateMesh("tetra_boi", vertices2, indices2);

    }
    
    // easy way with 4 vertices I guess? 
...

    {
        ...
        {
            VertexFormat(glm::vec3(-1, -1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, -1, 1), glm::vec3(255,0,0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        CreateMesh("magic_square", vertices3, indices3);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-0.5f, 0.5f, 1), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra_boi"], shaders["VertexColor"], glm::vec3(-2.0f, 0.5f, 2.0), glm::vec3(1.0f));

    // TODO(student): Draw the square
    RenderMesh(meshes["magic_square"], shaders["VertexColor"], glm::vec3(3.0f, 1.0f, 2.0), glm::vec3(1.0f));
